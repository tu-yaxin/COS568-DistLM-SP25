...
def train(args, train_dataset, model, tokenizer):
    ...
    with open(args.output_dir + "task1_losses.txt", "w") as file:
        import datetime
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            ####TODO:task1_losses_output
            if step < 5:
                with open(args.output_dir + "task1_losses.txt", "a") as file:
                    file.write(f"Step {step + 1}, Loss: {loss.item()}")
